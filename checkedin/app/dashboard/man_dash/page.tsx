...
export default function ManagerDashboard() {
  ...
  //delete function for manager to delete the checkin
 ...
 const  deleteCheckin = async (id: string) => {
  ...
  // front end 
    ...
    <div className="manager-dashboard">
      ...
      <p>
        It's great to see you today 🙋🏻‍♂️ Here you can manage your team and review staff
        check-ins 🚀
      </p>

      <div className="checkin-list">
        <h2>Review Check-ins ☑️</h2>
            ...
            {checkins.map((item) => (
              <tr key={item._id}>
                ...
                <td>
                  ...
                  <button
                    onClick={() => deleteCheckin(item._id)}
