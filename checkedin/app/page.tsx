      ...
      <main className="home-page">
        <section className="heading-main">
          ...
          <div className="moving-text">
            <p>
              ...
              check-ins with modern technology Our platform works with a
              seamless, automated ecosystem It not only tracks presence but
              enhances workflows and delivers real-time insights for better
              decision-making
            </p>
          </div>
        ...
        <div className="role-card">
          <div className="role-item">
            ...
            <p>
              {" "}
              Staff members can securely log in using their credentials to
              record their check-in, ensuring accurate attendance tracking and a
              seamless start to their workday
            </p>
          ...
          <div className="role-item">
            ...
            <p>
              {" "}
              Managers can instantly review employee check-ins and approve
              working hours with complete confidence
            </p>
            <button className="get-started-button">
        ...
        <section className="features">
          ...
          <div className="features-grid">
            ...
            <div className="feature-card">
              <h3>Secure Access</h3>
              <p>
                Staff can safely log in using their credentials to record
                attendance
              </p>
            </div>
            ...
            <div className="feature-card">
              ...
              <p>
                Managers can review check-ins and manage team attendance
                efficiently
              </p>
            </div>
          </div>
        ...
        <div className="faqs">
          ...
          <div className="faq-item">
            ...
            <p>
              Yes. CheckedIn uses secure authentication and data management
              practices to ensure that employee information and attendance
